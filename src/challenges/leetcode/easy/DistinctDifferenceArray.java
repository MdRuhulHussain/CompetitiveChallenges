...
/*
 * You are given a 0-indexed array nums of length n. The distinct difference array of nums is an array diff 
 * of length n such that diff[i] is equal to the number of distinct elements in the suffix nums[i + 1, ..., n - 1]
...
public class DistinctDifferenceArray {
	...
	public static void main(String args[]) {
		int[] nums = {3,2,3,4,2};
		int[] diff = distinctDifferenceArray(nums);
		for(int num : diff)
